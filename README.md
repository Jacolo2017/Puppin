...
```
cd existing_repo
git remote add origin https://gitlab.com/purely-puptonic/puppin.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/purely-puptonic/puppin/-/settings/integrations)
