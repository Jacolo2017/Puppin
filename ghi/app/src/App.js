        ...
        <Routes>
          ...
          <Route path="event">
            ...
            <Route
              path="home"
              element={[
                <LoggedinNav logout={logout} token={token} />,
                <Events token={token} />,
                <ReviewsGivenSlide token={token} />,
              ]}
            />
          </Route>
          <Route path="profile">
            <Route
              ...
              element={[
                <LoggedinNav logout={logout} token={token} />,
                <Profile currentUser={currentUser} token={token} />,
              ]}
            />
          ...
          />
          <Route
            path="join-event/:event"
            element={[<JoinEvent token={token} />]}
          />
        </Routes>
      </BrowserRouter>
    </>
