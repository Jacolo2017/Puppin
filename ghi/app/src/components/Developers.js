        ...
        <div className="bg-gray-300 rounded-xl shadow-2xl">
          <div className="p-10">
            ...
            <p className="text-center">
              Recent Software Engineering Bootcamp Grad with 6+ years of
              experience in the mechanical engineering field. I am seeking to
              pivot into the mechatronics, robotics, and automation fields by
              applying my experience in mechanical engineering and my new skills
              in software engineering. Lately I have been entranced by working
