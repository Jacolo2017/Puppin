...
const Developers = () => {
    return (
        <div className='w-screen h-screen text-center py-4 mt-1' id='contact'>
            <div className='py-4'>
                <h2 className='text-3xl pt-8 text-gray-800 uppercase font-bold'>Meet the</h2>
                <h3 className='text-5xl pt-8 text-gray-900 uppercase font-bold'>Developers</h3>
            </div>
            ...
            <div className='grid grid-cols-2 w-screen gap-12 px-10 py-20'>
                ...
                <div className='bg-gray-300 rounded-xl shadow-2xl'>
                    ...
                    <div className='bg-slate-200 pl-8 py-10 mt-6 flex justify-center items-center'>
                        <Link to='https://www.linkedin.com/in/mjesposito3/'><BsLinkedin className='w-10 h-10 text-blue-700' /></Link>
                        <div className=' px-10 text-2xl ml-4 font-semibold'>Connect with me!</div>
                    </div>
                </div>
                ...
                <div className='bg-gray-300 rounded-xl shadow-2xl'>
                    <div className='p-10'>
                        <img src='https://media-exp1.licdn.com/dms/image/C4E03AQGy0zsKhTT4Ig/profile-displayphoto-shrink_800_800/0/1654194278503?e=1663804800&v=beta&t=yL5rghfj5qNyLLaYmx6D7TfKHdsRH-dmU4aa_nr8CYk'
                            className='rounded-full w-20 mt-[-4rem]' />
                        <h3 className='uppercase font-bold text-center text-2xl py-4'>Jack Lemieux</h3>
                        <p className='text-center '>
                            ...
                            to me on LinkedIn or any of my other listed contact information and let's talk software development!
                            We can only keep up with technology's growth if we are willing to learn it!
                        </p>

                    </div>
                    <div className='bg-slate-200 pl-8 py-10 mt-6 flex justify-center items-center'>
                        <Link to='https://www.linkedin.com/in/jack-lemieux/?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAADW9Z3oBCPl3kh1iUkHj6sH6CPRopzTladM'><BsLinkedin className='w-10 h-10 text-blue-700' /></Link>
                        <div className=' px-10 text-2xl ml-4 font-semibold'>Connect with me!</div>
                    </div>
                </div>
                ...
                <div className='bg-gray-300 rounded-xl shadow-2xl'>
                    <div className='p-10'>
                        ...
                        <p className='text-left  py-2 indent-2'>
                            Hello! I’m a software developer that specializes in creating APIs, databases, message queues, and SPAs. In juggling both education and work, I've found that learning parallel in both environments (bootcamp/internship) has strengthened my understanding of both new and fundamental concepts whilst simultaneously gaining important experiences in collaborating within scrum teams to address the needs and requirements of end users.
                        </p>
                        <p className='text-left  py-2 indent-2'>
                            With this balance, I felt I was able to refine and absorb different perspectives of programming from both an educational standpoint and a professional one. Furthermore, the experiences have hardened my ability to learn and apply different languages/technologies to similar problems using a monolithic yet flexible mindset.                        </p>

                    </div>
                    <div className='bg-slate-200 pl-8 py-10 mt-6 flex justify-center items-center'>
                        <Link to='https://www.linkedin.com/in/roger-wang-b4024113b/'><BsLinkedin className='w-10 h-10 text-blue-700' /></Link>
                        <div className=' px-10 text-2xl ml-4 font-semibold'>Connect with me!</div>
                    </div>
                </div>
                ...
                <div className='bg-gray-300 rounded-xl shadow-2xl'>
                    <div className='p-10'>
                        <img src='https://media-exp1.licdn.com/dms/image/C5603AQFSHJsmcNyHKQ/profile-displayphoto-shrink_800_800/0/1653047500125?e=1663804800&v=beta&t=aTySCP3tZPgA7qLV5tf7fT2pN9dS3K8fy9I112Lp9d4'
                            className='rounded-full w-20 mt-[-4rem]' />
                        <h3 className='uppercase font-bold text-center text-2xl py-4'>Cooper Edmondson</h3>
                        <p className='text-center py-2'>
                        Hey! I am a 21 year old software engineer based in Georgia. All throughout my life I’ve had an infatuation with computers and that same passion is what lead me to software engineering. Software Engineering has been eye opening, and has shown me endless posabilities (and opportunities <span className='font-bold'>;)</span>  ) while allowing me to be creative, yet structured. I tried taking the college route but ultimately ended up deciding to go to Hack Reactor’s 19 week fully-immersive bootcamp, and honestly it was the best decision I have ever made.

                        </p>
                        <p className='text-center py-2'>
                        There I learned that I love working with the front-end because I feel like it’s where I can let my creativity shine. Being able to actually show people (users) what the back-end is capable of is one of my favorite parts of programming. Feel free to connect with me on Linkden!

                        </p>

                    </div>
                    <div className='bg-slate-200 pl-8 py-10 mt-6 flex justify-center items-center'>
                        <Link to='https://www.linkedin.com/in/cooper-edmondson/'><BsLinkedin className='w-10 h-10 text-blue-700' /></Link>
                        <div className=' px-10 text-2xl ml-4 font-semibold'>Connect with me!</div>
                    </div>
                </div>
            </div>
