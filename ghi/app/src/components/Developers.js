...
const Developers = () => {
    return (
        <div className='w-screen h-screen text-center py-20 mt-1' id='contact'>
            <div className='py-4'>
            ...
            <div className='grid grid-cols-2 w-screen gap-12 px-10 py-20'>
                ...
                <div className='bg-gray-300 rounded-xl shadow-2xl'>
                    ...
                    <div className='bg-slate-200 pl-8 py-10 mt-6'>
                        <a href='https://www.linkedin.com/in/mjesposito3/'><BsLinkedin className='w-8 h-10 text-blue-700' /></a>
                    </div>
                </div>
