...
const Hero = () => {
  return (
    <div className='bg-white h-screen flex flex-col justify-center items-center' id="home">
      ...
      <span class="text-red-600">P</span>urely P<span class="text-blue-600">U</span><span class="text-red-600">P</span>Tonic
      </h1> 
      <div>
      </div>
      <a className='bg-blue-400 rounded-full w-[160px] h-[50px] text-center py-3 shadow-lg hover:bg-blue-600 hover:text-gray-400 cursor-pointer'>
