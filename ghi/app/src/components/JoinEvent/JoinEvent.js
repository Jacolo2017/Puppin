    ...
    <>
      <div className='items-center h-screen w-screen bg-gradient-to-bl bg-[#00A1E4] from-[#0093d2] py-[140px]'>
        <div className='flex flex-col justify-center'>
          <form method="get" className='max-w-[500px] w-full mx-auto bg-gray-200 p-8 px-8 rounded-lg shadow-xl text-center' onSubmit={handleSubmit(onSubmit)}>
            <div className='font-bold text-2xl'>What dog are you bringing?</div>
            <select onChange={x => setUserSelectedDog(x.target.value)} id="dog-select" className="form-select bg-blue-700 hover:bg-slate-700 py-2 px-8 rounded font-bold  hover:bg-blue-300 shadow-sm text-white ">
            ...
            <input className="bg-blue-700 hover:bg-slate-700 mt-4 py-2 px-8 rounded font-bold  hover:bg-blue-300 shadow-sm text-white ml-4" type="submit" />
          </form></div></div>
    </>)
}