  ...
  return (
        <nav class="flex fixed justify-between items-center bg-white shadow-lg w-screen">
            ...
            <div class="flex items-center space-x-10 font-semibold capitalize px-4">
                ...
                <a href="https://gitlab.com/purely-puptonic/puppin" class="text-gray-600 hover:text-gray-800 hover:underline"><img src='https://cdn-icons-png.flaticon.com/512/25/25231.png' className='h-[20px]'></img></a>
            </div>
            <div className='px-8 py-2'>
                <a href="#_" class="px-9 py-2.5 relative rounded group overflow-hidden font-medium bg-blue-50 text-blue-800 inline-block">
