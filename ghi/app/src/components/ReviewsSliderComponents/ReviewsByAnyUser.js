              ...
              {eventReviews?.map(item => (
                ...
                <SwiperSlide className='pt-4 rounded-sm'>
                  ...
                  >
                    ...
                    <motion.h1 className='font-bold text-2xl'>{item.review_event}</motion.h1>
                    <motion.h2 className='py-4 font-semibold text-gray-800 text-lg'>{item.review_description} - <span className='text-green-500'>{item.reviewer_username}</span></motion.h2>
