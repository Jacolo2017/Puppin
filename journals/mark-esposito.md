## Aug 05 
Finally got the unit-test working thanks to curtis! The override dependancies were not working because I was importing the db querry from an incorrect filepath. once that was fixed, the tests started to actaully run... only took 4 hours to do the simple test, but at least all the troubleshooting made me learn even more about unit-tests and how the fastapi and psycopg actaully work together. Unfortunately I have to leave my team early today to catch a flight. Felt really bad to be leaving them at such a critical time. However the site is functional, unit-tests are starting to work, and all that is left is to get the project submitted! I'm so glad I have a great team.
